...
<div style="font-size:12px;color:#666;margin-bottom:12px;">Last updated: 2026-05-15</div>
...
<figure>
  ...
  <figcaption>Kerala Sr. Secondary School, Vikaspuri, New Delhi</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Guru Tegh Bahadur Institute of Technology (GTBIT), Delhi</figcaption>
</figure>

<p>In my first year, I joined <strong>GDSC (Google Developer Student Clubs)</strong> in the <strong>Design</strong> department — my first society in college.</p>

<p>During my first year, I made and published my first game — <strong>Fantasy Racer</strong> — on the Play Store. It had plenty of bugs and rough edges, but it was complete.</p>

<figure>
  <img src="https://raw.githubusercontent.com/abhay-byte/abhay-byte/main/assets/fantasy-racing.gif" alt="Fantasy Racer gameplay" style="max-width:100%;border-radius:8px;">
  <figcaption>Fantasy Racer — my first game</figcaption>
</figure>

<p>At the end of my first year, I landed my first job as a <strong>Game Developer</strong> at <strong>Gamified Company</strong> (based in Bengaluru) — a remote role where I worked on <strong>WordSea</strong>, a Wordle-style word game. Stayed there for 2 months.</p>
